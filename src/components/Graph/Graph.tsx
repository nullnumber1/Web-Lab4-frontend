...
const Graph = (props: any) => {
    ...
    let {data: points} = pointAPI.useFetchNewRadiusPointsQuery(props.radius);
    ...
    function drawCanvas(canvas: any) {
        ...
        function drawShapes(r: number) {
            ...
            function drawCircle() {
                ...
                ctx.arc(xAxis, yAxis, gapBetweenNotchesX * r/2, 0, Math.PI * 0.5);
                ctx.fill();
                ctx.closePath();
            }
            ...
            function drawTriangle() {
                ...
                ctx.lineTo(xAxis + gapBetweenNotchesX * r/2, yAxis);
                ctx.fill();
                ctx.stroke();
            }
        }
